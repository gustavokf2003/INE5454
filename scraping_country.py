...
with open("countries_geography.csv", mode="w", newline="", encoding="utf-8") as file:
    writer = csv.DictWriter(file, fieldnames=["Country", "Location", "Geographic coordinates", "Map references", "Area Total", "Area Land", "Area Water", "Climate"])
    writer.writeheader()
    ...
    print("✅ CSV salvo como 'countries_geography.csv'.")
